class DataStore {
    constructor() {
        this.members = [
            { id: 1, nama: 'Rahmat Fajar Saputra', nim: '210511001', idRfid: 'RF001ABC' },
            { id: 2, nama: 'NursyaBani', nim: '210511002', idRfid: 'RF002DEF' },
            { id: 3, nama: 'Muhammad Fajri', nim: '210511003', idRfid: 'RF003GHI' },
            { id: 4, nama: 'Asyifa Putri Romansha', nim: '210511004', idRfid: 'RF004JKL' },
            { id: 5, nama: 'Hanaviz', nim: '210511005', idRfid: 'RF005MNO' },
            { id: 6, nama: 'Bunga Jacinda', nim: '210511006', idRfid: 'RF006PQR' },
            { id: 7, nama: 'Muhammad Hafiz', nim: '210511007', idRfid: 'RF007STU' },
            { id: 8, nama: 'Naufal Rafiif Irwan', nim: '210511008', idRfid: 'RF008VWX' },
            { id: 9, nama: 'Daffa', nim: '210511009', idRfid: 'RF009YZA' },
            { id: 10, nama: 'Widia', nim: '210511010', idRfid: 'RF010BCD' },
        ];

        this.attendance = [
            { id: 1, memberId: 1, nama: 'Rahmat Fajar Saputra', tanggal: '2025-08-26', jam: '10.00', status: 'Hadir' },
            { id: 2, memberId: 2, nama: 'NursyaBani', tanggal: '2025-08-26', jam: '09.58', status: 'Hadir' },
            { id: 3, memberId: 3, nama: 'Muhammad Fajri', tanggal: '2025-08-25', jam: '-', status: 'Tidak Hadir' },
            { id: 4, memberId: 4, nama: 'Asyifa Putri Romansha', tanggal: '2025-08-25', jam: '10.05', status: 'Hadir' },
            { id: 5, memberId: 5, nama: 'Hanaviz', tanggal: '2025-08-24', jam: '-', status: 'Tidak Hadir' },
            { id: 6, memberId: 6, nama: 'Bunga Jacinda', tanggal: '2025-08-26', jam: '08.30', status: 'Hadir' },
            { id: 7, memberId: 7, nama: 'Muhammad Hafiz', tanggal: '2025-08-25', jam: '09.15', status: 'Hadir' },
            { id: 8, memberId: 8, nama: 'Naufal Rafiif Irwan', tanggal: '2025-08-24', jam: '-', status: 'Tidak Hadir' },
            { id: 9, memberId: 9, nama: 'Daffa', tanggal: '2025-08-26', jam: '11.00', status: 'Hadir' },
            { id: 10, memberId: 10, nama: 'Widia', tanggal: '2025-08-25', jam: '14.20', status: 'Hadir' },
            { id: 11, memberId: 1, nama: 'Rahmat Fajar Saputra', tanggal: '2025-08-27', jam: '09.30', status: 'Hadir' },
            { id: 12, memberId: 2, nama: 'NursyaBani', tanggal: '2025-08-27', jam: '-', status: 'Tidak Hadir' },
        ];
